...
class _EditRecordPageState extends State<EditRecordPage> {
  ...
  final noteController = TextEditingController(text: 'You will definitely die tomorrow.');
  var caretakerid;
    ...
    return TextField(
        ...
        onTap: () async {
          ...
          if(pickedDate!=null ){
            ...
            setState(() {
              startDateController.text=formattedDate; //set formatted date to TextField value.
            });
          }
          else{
